...
export const REPERES = [
  ...
  },
  {
    ...
    chiffres: [
      { v: '864 h / 973 h', l: 'heures d’enseignement par an en élémentaire et au collège ; 8 210 h sur la scolarité obligatoire, environ 600 de plus que la moyenne OCDE', src: 'ocde25' },
      { v: '36 contre 38', l: 'semaines de classe par an en France contre la moyenne OCDE : les mêmes heures tiennent dans moins de semaines, donc dans des journées plus longues — 7 h par jour au collège contre 5 ailleurs', src: 'ocde25' },
      { v: '59 %', l: 'du temps scolaire en élémentaire consacré au français et aux mathématiques : la proportion la plus élevée de tous les pays de l’OCDE', src: 'ocde25' },
      { v: '21,3', l: 'élèves par classe en moyenne (OCDE : 20 ; Union européenne : 19). Élémentaire public 20,9, maternelle 21,5, collège public 23,4', src: 'enchiffres25' },
